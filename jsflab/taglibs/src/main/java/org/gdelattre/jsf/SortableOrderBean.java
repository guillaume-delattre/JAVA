...
import org.gdelattre.jsf.model.SortableDataModel;
 
@ManagedBean(name="sortableOrder")
@SessionScoped
public class SortableOrderBean implements Serializable{
	...
	public SortableOrderBean(){
 
		this.sortableDataModel = new SortableDataModel<Order>(new ArrayDataModel<Order>(orderList));
