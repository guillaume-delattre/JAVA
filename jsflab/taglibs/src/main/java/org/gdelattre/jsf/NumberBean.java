...
public class NumberBean{
	...
	public boolean rememberMe;  //   <h:selectBooleanCheckbox...
	public List<String> favNumber1 = new ArrayList<String>();
	...
	public List<String> getFavNumber1() {
		return favNumber1;
	}

	public void setFavNumber1(List<String> favNumber1) {
	...
	public Number[] getNumber4List() {
		return number4List;
	}

	public void setNumber4List(Number[] number4List) {
		this.number4List = number4List;
	}
	
 
	public String getFavNumber1InString() {
		return favNumber1.toString();
	}
